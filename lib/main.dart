...
import 'package:binot/kategori_islemleri.dart';
import 'package:binot/models/kategori.dart';
import 'package:binot/models/notlar.dart';
import 'package:binot/utils/not_detay.dart';
import 'package:binot/utils/resim_detay.dart';
import 'package:flutter/material.dart';
import 'package:binot/utils/database_helper.dart';
...
class NotListesi extends StatelessWidget {
    ...
    return Scaffold(
      ...
      floatingActionButton: Column(
        ...
        children: <Widget>[
          ...
          FloatingActionButton(
            onPressed: () =>
                _resimEkleSayfasinaGit(context),
            heroTag: "ResimEkle",
            tooltip: "Resim Ekle",
            child: Icon(
              Icons.format_paint,
  ...
  void _resimEkleSayfasinaGit(BuildContext context) {
    Navigator.push(
        context,
        MaterialPageRoute(
